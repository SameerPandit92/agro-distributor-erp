...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "AgroERP API", Version = "v1" });
...
// ========================================================
// 🚀 यहाँ जोड़ा है ऑटो-माइग्रेशन कोड डॉकर के लिए
// ========================================================
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        context.Database.Migrate(); // यह कमांड डेटाबेस और टेबल्स अपने आप बना देगी
    }
    catch (Exception ex)
    {
        var logger = services.GetRequiredService<ILogger<Program>>();
        logger.LogError(ex, "डेटाबेस माइग्रेशन के दौरान एरर आया भाई।");
    }
}
// ========================================================
